...
operand getArrayOp(int basic_address, bool global, int dimension, int dimension1, int dimension2, expression subscript1,
    ...
    if (dimension == 1) {
        ...
        if (subscript1.op.kind == K_CONSTANT) {//表达式为常数,直接得出结果
            ...
            getArrayAddress.isArraySubPlus = true;
            //2.顶操作数
             ...
             */
//            fourOp saveArraySub;
//            saveArraySub.op = O_SaveArraySub;
//            saveArraySub.item1 = getArrayAddress.item1;
//            saveArraySub.item2 = getArrayAddress.item2;
//            saveArraySub.item3 = getArrayAddress.item3;
//            only_block.fourOpList.push_back(saveArraySub);
...
//            }
        ...
        if (row.kind == K_CONSTANT && column.kind == K_CONSTANT) {
            ...
            arrayAddress.isArraySubPlus = true;
...
//            fourOp saveArraySub;
//            saveArraySub.op = O_SaveArraySub;
//            saveArraySub.item1 = arrayAddress.item1;
//            saveArraySub.item2 = arrayAddress.item2;
//            saveArraySub.item3 = arrayAddress.item3;
//            only_block.fourOpList.push_back(saveArraySub);
        }
